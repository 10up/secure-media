...
var _window = window,
    ...
    smAdmin = _window.smAdmin;

if (wp && wp.media && wp.media.view) {
  jQuery(document).ready(function () {
    wp.media.view.AttachmentCompat.prototype.on('ready', function () {
      var visibleRow = document.querySelector('.compat-field-sm_visibility');

      if (!visibleRow) {
        return;
      }

      var field = visibleRow.querySelector('.field');
      var input = field.querySelector('input');
      var value = input.value;
      value = parseInt(value, 10) === 1;
      var attachmentId = input.name.replace(/^attachments\[([0-9]+)\].*$/, '$1');
      input.type = 'checkbox';
